...
classdef LoadFirmware < handle
    ...
    methods
        function obj = LoadFirmware(varargin)
            % Optional args:
            ...
            FirmwarePath = fileparts(which('LoadBpodFirmware'));
            ...
            load LoadFirmware_LastDevice; % Loads last device name
                ...
                if ispc
                    ...
                    if ~isempty(RawString)
                        ...
                        for p = 1:nPorts
                            ...
                            if ~strcmp(CandidatePort, 'COM1') && ~strcmp(CandidatePort, 'COM70') && ~strcmp(CandidatePort, 'COM323') && ~strcmp(CandidatePort, 'COM324')
                                novelPort = 1;
...
%             RawHIDs = strcat('SER#',RawHIDs);
            ...
            devicePos = find(strcmp(FirmwareNames,FileName(1:end-5)));
            if ~isempty(devicePos)
                set(obj.gui.Devices, 'Value', devicePos);
                obj.updateVersions();
            end
        ...
        function updateFirmware(obj, varargin)
            ...
            progressbar(0.6);
            if strcmp(ModuleName, 'StateMachine_Bpod1') || strcmp(ModuleName, 'StateMachine_Bpod05') || strcmp(ModuleName, 'PulsePal2')
            ...
            if OK
                ...
                set(obj.gui.Msg1, 'BackgroundColor', BGColor);
                set(obj.gui.Msg2, 'BackgroundColor', BGColor);
                Path = fileparts(which('LoadFirmware'));
                save(fullfile(Path, 'LoadFirmware_LastDevice.mat'), 'FileName');
            end
